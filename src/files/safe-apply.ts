...
interface SafeApply {
     ...
     *
     * Safely applies a function with a specific context.
     ...
     */
    <T extends ((...argArray: Parameters<T>) => ReturnType<T>)>
    (fn: T, thisArg: object | null, argArray: Parameters<T>): ReturnType<T>;
}
 ...
 * console.log(safeApply(getValue, obj, [12, 21, 19])); // Outputs: true
 */
export const safeApply: SafeApply = <T extends ((...argArray: Parameters<T>) => ReturnType<T>)>(
    fn: T,
    thisArg: object | null,
